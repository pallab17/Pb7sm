...
function createIcon(options) {
  ...
  const path = import_react5.Children.toArray(options.path);
...
function useAccordionItem(props) {
  ...
  const onFocus3 = (0, import_react8.useCallback)(() => {
    setFocusedIndex(index);
  }, [setFocusedIndex, index]);
  const getButtonProps = (0, import_react8.useCallback)(
  ...
  const getPanelProps = (0, import_react8.useCallback)(
...
var AccordionItem = forwardRef(
  function AccordionItem2(props, ref) {
    ...
    const ctx = (0, import_react9.useMemo)(() => context, [context]);
...
var Collapse = (0, import_react10.forwardRef)(
  (props, ref) => {
    const {
      in: isOpen,
      unmountOnExit,
...
var ScaleFade = (0, import_react12.forwardRef)(
...
var SlideFade = (0, import_react13.forwardRef)(
...
var Slide = (0, import_react14.forwardRef)(function Slide2(props, ref) {
  const {
    direction = "right",
    style,
    unmountOnExit,
...
function useImage(props) {
  ...
  const imageRef = (0, import_react16.useRef)();
...
function AvatarImage(props) {
  ...
  if (showFallback) {
    ...
    ) : (0, import_react17.cloneElement)(icon, {
      role: "img",
...
var focusScope = (0, import_react39.createContext)(void 0);
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react43.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react43.useCallback)(() => {
    var _a2;
...
var useSafeLayoutEffect2 = isBrowser ? import_react46.useLayoutEffect : import_react46.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react47 = __toESM(require_react(), 1);
function useCallbackRef3(fn, deps = []) {
  const ref = (0, import_react47.useRef)(fn);
...
function useClipboard(value, optionsOrTimeout = {}) {
  ...
  const [valueState, setValueState] = (0, import_react67.useState)(value);
  (0, import_react67.useEffect)(() => setValueState(value), [value]);
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react71.useMemo)(
    () => shouldWrapChildren ? import_react71.Children.map(children, (child, index) => (0, import_jsx_runtime71.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const clones = (0, import_react72.useMemo)(() => {
    ...
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      return (0, import_jsx_runtime74.jsxs)(import_react72.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime80.jsx)(import_jsx_runtime80.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime80.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime80.jsx)(import_react73.Fragment, { children: chunk.text }, index);
  }) });
}
...
var ModalTransition = (0, import_react77.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react78.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react79.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react79.useRef)(null);
  const onMouseDown = (0, import_react79.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react79.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react79.useState)(false);
  const getDialogProps = (0, import_react79.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react79.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react79.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react85.useState)(false);
  const [action, setAction] = (0, import_react85.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react85.useState)(true);
  const timeoutRef = (0, import_react85.useRef)(null);
  ...
  const up = (0, import_react85.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react85.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react85.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const inputSelectionRef = (0, import_react86.useRef)(null);
  const incrementButtonRef = (0, import_react86.useRef)(null);
  const decrementButtonRef = (0, import_react86.useRef)(null);
  const sanitize = (0, import_react86.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse3 = (0, import_react86.useCallback)(
    (value) => {
      var _a2;
  ...
  const format = (0, import_react86.useCallback)(
    (value) => {
      var _a2;
  ...
  const _onFocus = (0, import_react86.useCallback)(
    (event) => {
      var _a2, _b, _c;
  ...
  const ariaValueText = (0, import_react86.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react86.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react86.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  }, [clampValueOnBlur, setFocused, validateAndClamp]);
  const focusInput = (0, import_react86.useCallback)(() => {
  ...
  const spinUp = (0, import_react86.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react86.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react86.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react86.useCallback)(
    (props2 = {}, ref = null) => {
...
var NumberInput = forwardRef(
  function NumberInput2(props, ref) {
    ...
    const ctx = (0, import_react87.useMemo)(() => context, [context]);
...
function usePinInput(props = {}) {
  ...
  const [moveFocus2, setMoveFocus] = (0, import_react88.useState)(true);
  ...
  const focusNext = (0, import_react88.useCallback)(
    (index) => {
  ...
  const setValue = (0, import_react88.useCallback)(
  ...
  const clear = (0, import_react88.useCallback)(() => {
    var _a2;
  ...
  const getNextValue = (0, import_react88.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react89.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  const child = import_react90.Children.only(props.children);
  const { getTriggerProps } = usePopoverContext();
  return (0, import_react90.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react91.useRef)(null);
  const triggerRef = (0, import_react91.useRef)(null);
  const popoverRef = (0, import_react91.useRef)(null);
  const isHoveringRef = (0, import_react91.useRef)(false);
  const hasBeenOpened = (0, import_react91.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react91.useState)(false);
  const [hasBody, setHasBody] = (0, import_react91.useState)(false);
  ...
  const getPopoverProps = (0, import_react91.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react91.useCallback)(
  ...
  const getAnchorProps = (0, import_react91.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react91.useRef)();
  const closeTimeout = (0, import_react91.useRef)();
  const maybeReferenceRef = (0, import_react91.useCallback)(
    (node2) => {
  ...
  const getTriggerProps = (0, import_react91.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getHeaderProps = (0, import_react91.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react91.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node2) => {
...
function PopoverAnchor(props) {
  const child = import_react92.Children.only(props.children);
  const { getAnchorProps } = usePopoverContext();
  return (0, import_react92.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const focus2 = (0, import_react93.useCallback)(() => {
  ...
  const getRadioProps = (0, import_react93.useCallback)(
    (props2 = {}, ref2 = null) => {
      const checkedKey = isNative ? "checked" : "isChecked";
      return {
        ...props2,
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react94.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react95.useId)()}`;
  ...
  const [isHovered, setHovering] = (0, import_react95.useState)(false);
  const [isActive, setActive] = (0, import_react95.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react95.useState)(Boolean(defaultChecked));
  ...
  const onKeyUp = (0, import_react95.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getRadioProps = (0, import_react95.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-active": dataAttr(isActive),
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react96.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime124.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react96.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react97.useRef)(true);
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react100.useRef)(null);
...
var useSafeLayoutEffect3 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react101.useLayoutEffect : import_react101.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react101.useState)([]);
  const [count, setCount] = (0, import_react101.useState)(0);
...
function useRangeSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react102.useState)(false);
  const [isFocused, setFocused] = (0, import_react102.useState)(false);
  const [activeIndex, setActiveIndex] = (0, import_react102.useState)(-1);
  const isInteractive = !(isDisabled || isReadOnly);
  const initialValue = (0, import_react102.useRef)(valueState);
  ...
  const isVertical = orientation === "vertical";
  const trackRef = (0, import_react102.useRef)(null);
  const rootRef = (0, import_react102.useRef)(null);
  ...
  const getValueFromPointer = (0, import_react102.useCallback)(
    (event) => {
      var _a2, _b;
      if (!trackRef.current)
        return;
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react102.useMemo)(
    () => getStyles3({
      isReversed,
      orientation,
      thumbRects,
  ...
  const focusThumb = (0, import_react102.useCallback)(
    (index) => {
      var _a2;
  ...
  const getTrackProps = (0, import_react102.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getInnerTrackProps = (0, import_react102.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react102.useCallback)(
    (props2, ref = null) => {
      var _a2;
      const { index, ...rest } = props2;
  ...
  const getOutputProps = (0, import_react102.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getMarkerProps = (0, import_react102.useCallback)(
    (props2, ref = null) => {
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react103.useMemo)(
...
function useSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react104.useState)(false);
  ...
  const trackRef = (0, import_react104.useRef)(null);
  const thumbRef = (0, import_react104.useRef)(null);
  const rootRef = (0, import_react104.useRef)(null);
  const reactId = (0, import_react104.useId)();
  const uuid = idProp != null ? idProp : reactId;
  const [thumbId, trackId] = [`slider-thumb-${uuid}`, `slider-track-${uuid}`];
  const getValueFromPointer = (0, import_react104.useCallback)(
    (event) => {
      var _a22, _b;
      if (!trackRef.current)
        return;
  ...
  const constrain = (0, import_react104.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
  ...
  const actions = (0, import_react104.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react104.useMemo)(() => {
    const state2 = stateRef.current;
  ...
  const focusThumb = (0, import_react104.useCallback)(() => {
    const state2 = stateRef.current;
  ...
  const getTrackProps = (0, import_react104.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref: mergeRefs(ref, trackRef),
  ...
  const getInnerTrackProps = (0, import_react104.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react104.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getMarkerProps = (0, import_react104.useCallback)(
    (props2, ref = null) => {
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react106.useState)(index);
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react107.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react107.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react107.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react108.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react108.createElement)(
      TabPanelProvider,
      {
        key: index,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react108.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react108.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react108.useState)(false);
  useSafeLayoutEffect(() => {
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react110.useRef)();
  const clearEnterTimeout = (0, import_react110.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react110.useRef)();
  const clearExitTimeout = (0, import_react110.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react110.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react110.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react110.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
  ...
  const onPointerDown = (0, import_react110.useCallback)(() => {
  ...
  const getTooltipPositionerProps = (0, import_react110.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react110.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  let trigger2;
  if (shouldWrap) {
    trigger2 = (0, import_jsx_runtime165.jsx)(
      chakra.span,
      {
        display: "inline-block",
        tabIndex: 0,
    ...
    trigger2 = (0, import_react111.cloneElement)(
      child,
  ...
  if (!label) {
    return (0, import_jsx_runtime165.jsx)(import_jsx_runtime165.Fragment, { children });
  }
  return (0, import_jsx_runtime165.jsxs)(import_jsx_runtime165.Fragment, { children: [
    trigger2,
    (0, import_jsx_runtime165.jsx)(AnimatePresence, { children: tooltip.isOpen && (0, import_jsx_runtime165.jsx)(Portal, { ...portalProps, children: (0, import_jsx_runtime165.jsx)(
      chakra.div,
      {
        ...
        children: (0, import_jsx_runtime165.jsxs)(
          MotionDiv3,
          {
            variants: scale,
            initial: "exit",
            ...
            children: [
              label,
              hasAriaLabel && (0, import_jsx_runtime165.jsx)(chakra.span, { srOnly: true, ...srOnlyProps, children: ariaLabel }),
              hasArrow && (0, import_jsx_runtime165.jsx)(
                chakra.div,
                {
                  "data-popper-arrow": true,
                  className: "chakra-tooltip__arrow-wrapper",
                  children: (0, import_jsx_runtime165.jsx)(
                    chakra.div,
                    {
